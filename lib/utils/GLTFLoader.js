...
var _DDSLoader = require('./DDSLoader');

var _DDSLoader2 = _interopRequireDefault(_DDSLoader);

var _BufferGeometryUtils = require('./BufferGeometryUtils');

var _BufferGeometryUtils2 = _interopRequireDefault(_BufferGeometryUtils);
...
var GLTFLoader = function () {
  ...
  */
	function GLTFTextureDDSExtension() {
		...
		if (!_DDSLoader2.default) {

			throw new Error('THREE.GLTFLoader: Attempting to load .dds texture without importing DDSLoader');
		}

		this.name = EXTENSIONS.MSFT_TEXTURE_DDS;
		this.ddsLoader = new _DDSLoader2.default();
	}
		...
		return this.getDependencies('accessor').then(function (accessors) {
			...
			return Promise.all(pending).then(function (geometries) {
				...
				if (isMultiPass) {
					...
					return [geometry];
				} else if (geometries.length > 1 && _BufferGeometryUtils2.default !== undefined) {
					...
					if (cached) {
						...
						var geometry = _BufferGeometryUtils2.default.mergeBufferGeometries(geometries, true);
